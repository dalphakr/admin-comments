...
function readPageAttributes() {
  ...
  var url = params.url.substr(-1, 0) === "/" ? params.url : params.url + "/";
  return {
    owner: matches[1],
    repo: matches[2],
    issueTerm: issueTerm,
...
var UTTERANCES_API = 'https://utterances-api.huey.xyz';
...
function bootstrap() {
  return __awaiter(this, void 0, void 0, function () {
    var user, issue, hideTimeline, _a, userResult, issueResult, error_1, timeline, submit, newCommentComponent;
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          user = {}, issue = {}, hideTimeline = false;
          _b.label = 2;

        case 2:
          _b.trys.push([2, 4,, 5]);

          return [4, Promise.all([(0, _github.loadUser)(), loadIssue(), (0, _theme.loadTheme)(_pageAttributes.pageAttributes.theme, _pageAttributes.pageAttributes.origin)])];

        case 3:
          _a = _b.sent(), userResult = _a[0], issueResult = _a[1];
          user = userResult;
          issue = issueResult;
          return [3, 5];
